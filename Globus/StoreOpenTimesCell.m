...
#define kiPhoneDetailTextLabelOriginX 170.0
...
@implementation StoreOpenTimesCell

NSString *const kStoreOpenTimesCellId = @"StoreOpenTimesCellId";
...
- (void)layoutSubviews {
	...
	{
		self.textLabel.frame = CGRectMake(contentRect.origin.x + 15.0, contentRect.origin.y + 5.0, contentRect.size.width - 10.0 - _formfieldCellWidth - 10.0 - 10.0, contentRect.size.height - 10.0);
	}
